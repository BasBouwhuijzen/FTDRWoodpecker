...
# Compute the correlation between reviews_per_month and construction_year
...
```{r}
# Plot leverage values for the model
model_3 %>%
  hatvalues() %>%
  plot(main = "Leverage Values for Model 3", 
...
```{r}
# Normality check for residuals of Model 3.1 by creating Q-Q plot
qqnorm(resid(model_3.1), 
       col = "darkgrey",
       main = "Q-Q Plot of Residuals for Model 3.1)")
qqline(resid(model_3.1), 
       col = "dodgerblue", 
       lwd = 2)
```
